...
<head>
  ...
  <title>dogSNSログイン画面</title>
  <link rel="stylesheet" href="./css/output.css">
</head>

<body>
  <!-- <form action="dogSNS_login_act.php" method="POST">
    <fieldset>
      <legend>dogSNSログイン画面</legend>
      <div>
      ...
      <a href="dogSNS_register.php">or register</a>
    </fieldset>
  </form> -->
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <form class="mx-auto max-w-lg rounded-lg border" action="dogSNS_login_act.php" method="POST">
      <div class="flex flex-col gap-4 p-4 md:p-8">
        <div>
          <label for="email" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">username</label>
          <input type="text" name="username" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>

        <div>
          <label for="password" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Password</label>
          <input type="text" name="password" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>
        ...
        <div class="relative flex items-center justify-center">
          ...
          <span class="relative bg-white px-4 text-sm text-gray-400">初めてのユーザー</span>
        </div>

        </form>


        <form action="dogSNS_register.php" method="get">
    <input type="submit" value="アカウント登録" class="block rounded-lg bg-gray-800 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">
</form>
